...
device = check_device()
from models.pytorch_cifar10.inception import inception_v3
...
class ComposedModel():
    ...
    def get_model(self):
        ...
        self.model = inception_v3(num_classes=10)
        state_dict = torch.load('ckpt/inception_v3.pt', map_location=device)
