...
device = check_device()
from models.pytorch_cifar10.densenet import densenet121
...
class ComposedModel():
    ...
    def get_model(self):
        ...
        self.model = densenet121(num_classes=10)
        state_dict = torch.load('ckpt/densenet121.pt', map_location=device)
