...
class BIG:
    r"""
        ...
        Arguments:
            ...
            class_num (int): Number of classes. (Default: 10)
        ...
        __call__:
            ...
            Returns:
                (np.ndarray, bool): Attribution map and success flag.
            
        Examples::
            >>> attack = BIG(model, attacks)
            >>> attribution_map, success = attack(model, images, labels)
    """
